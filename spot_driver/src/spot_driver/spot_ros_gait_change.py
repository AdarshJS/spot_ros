...
from .spot_wrapper_gait_change import SpotWrapper
...
class SpotROS():
    ...
    def cmdVelCallback(self, data):
        ...
        print("Inside cmd_vel callback in gait change.")
        self.spot_wrapper.velocity_cmd(data.linear.x, data.linear.y, data.angular.z, data.angular.x)
